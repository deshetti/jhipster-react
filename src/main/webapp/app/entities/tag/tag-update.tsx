...
export const TagUpdate = (props: ITagUpdateProps) => {
  ...
  const { tagEntity, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterReact680App.tag.home.createOrEditLabel">Create or edit a Tag</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : tagEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="descriptionLabel" for="tag-description">
                  Description
                </Label>
                <AvField id="tag-description" type="text" name="description" />
              </AvGroup>
